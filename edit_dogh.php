                    ...
                    <div class="form-grid">
                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="barangay" name="barangay" value="<?= htmlspecialchars($dog['barangay']) ?>" required>
                            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            menuItems.forEach(item => {
                ...
                if (currentPage === 'dog_edit.php' && item.getAttribute('href') === 'dog_list.php') {
