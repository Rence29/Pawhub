...
$sql = "
    ...
    WHERE (ah.adopter_name LIKE ? OR ah.dog_breed LIKE ?)
    ORDER BY ah.processed_date DESC
";
...
<head>
    ...
    <title>Pawhub - Adoption History</title>
        ...
        <aside class="sidebar">
            ...
            <ul class="menu">
                ...
                <li class="menu-item active">
                    <a href="adoption_history.php" class="active">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            menuItems.forEach(item => {
                ...
                if (linkHref && linkHref.endsWith(currentPage)) {
                    ...
                    item.parentElement.classList.add('active'); // Add to the parent li
                }
            });
        });
    </script>
